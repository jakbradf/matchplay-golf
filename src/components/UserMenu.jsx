...
import { GoogleIcon, UserIcon, HistoryIcon, UsersIcon, TrophyIcon } from './GolfIcon';
    ...
    <div className="user-menu" ref={menuRef}>
      ...
      {open && (
        <div className="user-dropdown">
          ...
          <button
            className="user-dropdown-item"
            onClick={() => { navigate('/my-tournaments'); setOpen(false); }}
          >
            <TrophyIcon size={16} color="var(--green-dark)" />
            My Tournaments
          </button>
          <button
            className="user-dropdown-item"
