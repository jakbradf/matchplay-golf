import { buildScorecardData, computeMatchScore, getMatchplayStrokes, adjustTeamsForCourse } from '../utils/scoring';
...
export default function ScorecardGrid({ scores, teams, course }) {
